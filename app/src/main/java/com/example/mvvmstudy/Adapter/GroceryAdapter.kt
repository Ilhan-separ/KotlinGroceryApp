...

{
    ...
    override fun onBindViewHolder(holder: GroceryViewHolder, position: Int) {
        ...
        holder.binding.itemPriceText.text = "Fiyat : ${currentPosition.itemPrice}TL"
        holder.binding.itemAmountText.text = "Miktar : ${currentPosition.itemQuantity}"
        holder.binding.deleteButton.setOnClickListener {
            ...
            mainbinding.mainAmountText.text = "Bedel : ${anan} TL "
